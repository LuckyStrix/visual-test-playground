...
from .stimuli import DARK_STEPS, LIGHT_STEPS, halftone_patch, match_pair, step_row
...
def test_profile_meta_and_comparability():
    a = DisplayProfile(
        ...
        refresh_hz=60.0,
        ambient="dim room",
        black_step_visible=3,
        white_step_visible=2,
    )
    meta = a.as_meta()
